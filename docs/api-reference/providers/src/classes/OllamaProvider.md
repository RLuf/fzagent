...
[fzagent API Reference](../../../README.md) / [providers/src](../README.md) / OllamaProvider

# Class: OllamaProvider

Defined in: providers/src/adapters/ollama.ts:57
...
> **new OllamaProvider**(`opts`): `OllamaProvider`

Defined in: providers/src/adapters/ollama.ts:62
...
Defined in: providers/src/adapters/ollama.ts:59
...
Defined in: providers/src/adapters/ollama.ts:58
...
Defined in: providers/src/adapters/ollama.ts:68
...
Defined in: providers/src/adapters/ollama.ts:132
